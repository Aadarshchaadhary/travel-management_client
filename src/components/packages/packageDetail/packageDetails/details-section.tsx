  ...
  return (
    <div className="relative w-full h-full px-2">
      ...
      <div className="flex items-center gap-1 mt-2">
        ...
        <span className="text-[18px] mt-1 font-semibold text-gray-700">
          {pkg.price.toFixed(2)}{" "}
          {pkg.cost_type.replace("_", " ").toLocaleLowerCase()}
        </span>
      </div>
      ...
      <div className="flex gap-2 flex-wrap mt-3">
        ...
        <div className="flex gap-1 items-center border border-gray-300 w-fit py-1 px-2 rounded-md ">
          ...
          <p className="text-[18px] mt-1 font-semibold text-gray-700">
            {pkg.category.name}
          </p>
        </div>
        ...
        <div className="flex items-center gap-1 mt-1 text-[18px]  border border-gray-300 w-fit py-1 px-2 rounded-md">
          ...
          <span className="text-[18px] font-semibold text-gray-700">
            {pkg.seats_available} / {pkg.total_seats}
          </span>{" "}
          seats available
        </div>
